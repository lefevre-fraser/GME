...
// Custom values
// For system values see STATUS_ACCESS_VIOLATION in WinNT.h, EXCEPTION_ACCESS_VIOLATION in WinBase.h
#define EXC_SIGNAL_ABORT			((DWORD)0xC0000100L)
#define EXC_PURE_CALL				((DWORD)0xC0000101L)
#define EXC_TERMINATE				((DWORD)0xC0000102L)
#define EXC_UNEXPECTED				((DWORD)0xC0000103L)
