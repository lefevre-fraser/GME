...
char* CPreference::m_szAtomPreferenceTable[][5]=
{
	...
	{"BOOLEAN_LIST",	"itemShadowCast",	"false",		"Shadow cast enabled",			"Is the shadow casting feature enabled."},
	...
	{"BOOLEAN_LIST",	"roundEdgeRect",	"false",		"Round rectangle edge enabled",	"Is rounding of rectangle edges feature enabled."},
	{"STRING",			"roundEdgeRadius",	"9",			"Round rectangle edge radius",	"Radius of round rectangle edges."},
	{"STRING",			"preferredSize",	"",				"Custom preferred size",		"Custom preferred size of the item, format: width,height."},
...
char* CPreference::m_szModelPreferenceTable[][5]=
{
	...
	{"STRING",			"shadowThickness",	"9",			"Shadow thickness/offset",				"Thickness/offset of the shadow."},
	{"STRING",			"shadowDirection",	"45",			"Shadow direction (angle)",				"Direction of the shadow (angle)."},
	{"BOOLEAN_LIST",	"roundEdgeRect",	"false",		"Round edge rectangle enabled",			"Is rounding of rectangle edges feature enabled."},
	{"STRING",			"roundEdgeRadius",	"9",			"Round edge radius",					"Radius of round rectangle edges."},
	{"STRING",			"preferredSize",	"",				"Custom preferred size",				"Custom preferred size of the item, format: width,height."},
