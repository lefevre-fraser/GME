...
namespace Decorator
{
	enum ELocation { L_NORTH = GME_NORTH, L_SOUTH = GME_SOUTH, L_WEST = GME_WEST, L_EAST = GME_EAST, L_SOUTHWEST = GME_SOUTHWEST, L_SOUTHEAST = GME_SOUTHEAST, L_NORTHWEST = GME_NORTHWEST, L_NORTHEAST = GME_NORTHEAST, L_CENTER = GME_CENTER };
	enum EPrefStatus { PS_HERE = 0, PS_META = -1, PS_INHERITED = 1, PS_UNDEFINED = 2 };
