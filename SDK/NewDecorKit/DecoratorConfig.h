...
#define TYPELIB_NAME "Sample NewDecorator TypeLibrary (Decorator)"
#define COCLASS_UUID "13C74795-8161-4813-B8C6-9D4C3365875C"
#define COCLASS_NAME "Sample NewDecorator CoClass (Decorator)"
#define COCLASS_PROGID "MGA.NewDecorator.SampleDecorator"

#define CONSTOLESTR(X)		OLESTR(X)


// This name will appear in the popup window for interpreter selection.
#define DECORATOR_NAME "SampleNewDecorator"
