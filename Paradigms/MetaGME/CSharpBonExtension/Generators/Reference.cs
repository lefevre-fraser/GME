...
";
        ...
        public string GenerateReferences(ref List<string> names, ref StringBuilder forInterface)
        {
            ...
            {
                if (parent is Reference)
                    sb.Append((parent as Reference).GenerateReferences(ref names, ref forInterface));
            }
        ...
        private string generateReference(FCO current)
        {
            ...
            if (current.HasChildren)
            {
                ...
                {
                    inner.AppendFormat(Reference.Template.ReferenceInner, child.className, child.ProperClassName, child.memberType);
                }
            }
